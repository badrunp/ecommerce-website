...
function ButtonOutline({ children, className = 'text-gray-600 border-gray-300', bgColor = 'bg-white hover:bg-gray-50 focus:ring-2 focus:ring-blue-300 focus:ring-offset-1' }) {
    return (
