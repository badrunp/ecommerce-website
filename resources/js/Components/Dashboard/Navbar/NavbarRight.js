                                ...
                                <div className="bg-white shadow rounded-md py-2 px-4 w-64">
                                    <div className="w-full py-6 border-b border-gray-300">
                                        <div className="flex flex-col items-center justify-center space-y-1">
                                            ...
                                            <h3 className="block text-base truncate font-bold text-gray-500 tracking-tight">{auth && auth.name}</h3>
                                            <h3 className="block text-base truncate font-bold text-gray-500 tracking-tight">{auth && auth.email}</h3>
