...
function Navbar({ sidebarOpen, setSidebarOpen, width }) {
    return (
        <motion.div variants={containerVariants} custom={width} className="fixed w-full h-14 md:h-16 bg-transparent left-0 pl-60 shadow-sm bg-gradient-to-br bg-white z-20">
